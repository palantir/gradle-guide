...
public interface ExtensionClassMatcher extends MethodInvocationTreeMatcher {
    ...
    Description matchExtensionClass(ClassSymbol extensionClass, MethodInvocationTree tree, VisitorState state);
    ...
    default Description matchMethodInvocation(MethodInvocationTree tree, VisitorState state) {
        ...
        return Optional.ofNullable(ASTHelpers.getType(classArg))
                ...
                .map(classSymbol -> matchExtensionClass(classSymbol, tree, state))
